...
<script>
/* Umschalter. Beide Ansichten sind bereits gezeichnet; hier wird nur
   sichtbar gemacht, was gerade gefragt ist. */
(function () {{
  const TEXTE = {{
    scout: "<b>Das sieht ein Scout.</b> Vier Fälle sind offen und ausfüllbar, "
      + "zwei sind abgegeben und zeigen die Sofort-Rückmeldung. Die Daten "
      + "stammen aus einem echten Lauf mit zehn Testscouts auf erfundenen "
      + "Spielern.",
    admin: "<b>Das sieht die Redaktion.</b> Abgabestand und Auflösung unter "
      + "<i>Übersicht</i>, die fünf Diagnosen aus dem Scout Rating Audit unter "
      + "<i>Kalibrier-Report</i>.",
  }};
